...
def create(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return HttpResponseRedirect(reverse("academics:index"))
        else:
            # If the form is invalid, re-render the page
            return render(request, "academics/create.html", {
...
def roster(request):
    return render(request, "academics/roster.html", {
...
def details(request, course_id):
    return render(request, "academics/details.html", {
...
def profile(request, user_id):
    ...
    return render(request, "academics/profile.html", {
        "person": person,
        "courses": courses
    })
...
def section(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return render(request, "academics/select.html", {
                "section": section,
                "courses": Course.objects.filter(section=section)
            })
        else:
            # If the form is invalid, re-render the page
            return render(request, "academics/section.html", {
...
def select(request):
    if request.method == "POST":
        ...
        return render(request, "academics/success.html", {
            "student": student,
            "action": "added",
            "course": course,
...
def drop(request):
    ...
    return render(request, "academics/drop.html", {
        "courses": Course.objects.filter(students__id=request.user.id)
    })
...
def remove(request):
    ...
    return render(request, "academics/remove.html", {
